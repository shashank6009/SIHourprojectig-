...
c:["$","$1","c",{"children":[["$","$L11",null,{"Component":"$12","searchParams":{},"params":{"locale":"ta"},"promises":["$@13","$@14"]}],[["$","script","script-0",{"src":"/_next/static/chunks/53ded1433d5a7613.js","async":true,"nonce":"$undefined"}]],["$","$L15",null,{"children":["$L16",["$","$L17",null,{"promise":"$@18"}]]}]]}]
