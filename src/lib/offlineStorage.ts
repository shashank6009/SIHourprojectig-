...
// Global instances - only create on client side
export const offlineStorage = typeof window !== 'undefined' ? new OfflineStorageManager() : null;
export const offlineSync = typeof window !== 'undefined' ? new OfflineSyncManager() : null;
